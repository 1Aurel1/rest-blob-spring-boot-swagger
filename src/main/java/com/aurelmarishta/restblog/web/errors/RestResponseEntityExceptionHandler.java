package com.aurelmarishta.restblog.web.errors;

import com.aurelmarishta.restblog.user.errors.UserAlreadyExistException;
import com.aurelmarishta.restblog.user.errors.UserNotFoundException;
import com.aurelmarishta.restblog.web.util.GenericResponse;
